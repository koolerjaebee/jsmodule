...
- **[Jinseob Kim](https://github.com/jinseob2kim)**. Author, maintainer.
  [](https://orcid.org/0000-0002-9403-605X)

- **[![](https://raw.githubusercontent.com/zarathucorp/zarathu/master/Color%20logo%20-%20no%20background.png)](https://www.zarathu.com)**.
...
- **Jinhwan Kim**. Author. [](https://orcid.org/0009-0009-3217-2417)

- **Yoonkyoung Jeon**. Author.

- **Jaewoong Heo**. Author.

- **Youngsun Park**. Author. [](https://orcid.org/0009-0009-9336-2281)
...
Source:
[`DESCRIPTION`](https://github.com/jinseob2kim/jsmodule/blob/master/DESCRIPTION)

Kim J, Lee H, Lim C, Kim J, Jeon Y, Heo J, Park Y, Jo H, Seo J, LEE H,
Choi S, Kang Y, Jee M (2025). *jsmodule: 'RStudio' Addins and 'Shiny'
Modules for Medical Research*. R package version 1.6.15,
